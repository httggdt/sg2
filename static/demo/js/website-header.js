...
var headerSDK = {
    ...
    website_url: {
        ...
        'prod': 'http://www.youzu.com'
    },
    server_url: {
        'qa': 'https://qapic.youzu.com',
        'prod': 'http://pic.youzu.com'
    },
    home_apiUrl: {
        'qa': 'https://qahome.youzu.com',
        'prod': 'http://home.youzu.com'
    },
    js_list: [
        'http://pic.youzu.com/common/js/xg.js?v=',
        'http://pic.youzu.com/common/reg_login/js/login.js?v=',
        'http://pic.youzu.com/common/jquery-1.8.3.min.js?v=',
        'http://pic.youzu.com/common/jquery.cookie.js?v=',
        'http://pic.youzu.com/common/reg_login/js/showPop.js?v=',
        'http://pic.youzu.com/m/web/mobile/js/jQuery.md5.js?v=',
        './js/siteTopBar_v5.js?v=',
    ],
    css_list: [
    ...
    link: {
        'qa': {
            ...
            'shop': 'http://qashop.youzu.com/',
            'pay': 'http://qapay.youzu.com/',
            'bbs': 'http://qaforum.youzu.com/',
            'user_center': 'https://qahome.youzu.com/',
            'service': 'http://qaservice.youzu.com/',
            'live': 'https://tv.youzu.com',
            'news': 'https://qawww.youzu.com/news.html',
            'pact': 'http://qapact.youzu.com',
            'coming': 'http://qawww.youzu.com/site/coming'
        },
        'prod': {
            'www': 'https://www.youzu.com/',
            'shop': 'http://shop.youzu.com/',
            'pay': 'http://pay.youzu.com/',
            'bbs': 'http://forum.youzu.com/',
            'user_center': 'https://home.youzu.com/',
            'service': 'http://service.youzu.com/',
            'live': 'https://tv.youzu.com',
            'news': 'https://www.youzu.com/news.html',
            'pact': 'http://qapact.youzu.com',
            'coming': 'http://www.youzu.com/site/coming'
        }
    },
    ...
    createJs: function() {
        ...
        var lab_url = 'https://pic.youzu.com/youzu/web/website_header/js/labjs.min.js?' + this.version;
		    ...
		    <div class="game-gameTop">\
		        ...
		        <ul class="game-gameNav">\
		            ...
		            <div class="header-prompt header-prompt-close" style="display:none;" id="linkRelName">\
		                <i></i> 为了您的账号安全，请尽快进行\
		                <a href="https://home.youzu.com/id/index">实名认证 </a> ！<b>×</b>\
		            </div>\
		        </ul>\
