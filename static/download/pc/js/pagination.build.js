    ...
    var zp = {
        ...
        addhtml: function (obj, pageinit) {
            return (function () {
                ...
                for (; start <= end; start++) {
                    if (start <= pageinit.pageNum && start >= 1) {
                        if (start == pageinit.current) {
                            ...
                            obj.append('<a href="javascript:;" class="zxfPagenum nextpage">' +
                                start + '</a>');
                        } else {
                            obj.append('<a href="javascript:;" class="zxfPagenum">' + start +
                                '</a>');
                        }
                    }
                }
                ...
                // obj.append('<span>' + '鍒扮' + '<input type="number" class="zxfinput" value="5"/>' +
                //     '椤�' + '</span>');
